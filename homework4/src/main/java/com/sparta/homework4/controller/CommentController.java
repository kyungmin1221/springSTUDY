...
public class CommentController {
    ...
    public ResponseEntity<CommentDto.CommentResponseDto> updateComment(@PathVariable Long userId, @PathVariable Long commentId, @RequestBody CommentDto.CommentPatchDto patchDto) {
